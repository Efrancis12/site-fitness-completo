      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center space-x-2 mb-4">
            <div className="w-10 h-10 bg-gradient-to-r from-[#00ff88] to-[#00cc6a] rounded-lg flex items-center justify-center">
              <Dumbbell className="w-6 h-6 text-black" />
            </div>
            <span className="text-2xl font-bold">LifeFitnessON</span>
          </div>
          
          <h1 className="text-2xl font-bold mb-2">
            Sua <span className="text-[#00ff88]">evolução</span> começa aqui
          </h1>
          <p className="text-gray-400">
            Acesse sua conta ou crie uma nova para começar sua jornada fitness
          </p>
        </div>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="login" className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href="#" className="text-sm text-[#00ff88] hover:underline">
                    Esqueci a senha
                  </Link>
                </div>
